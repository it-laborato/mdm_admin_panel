 ...
 * @author isv
 */
public class PushPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>PushPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public PushPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.push.persistence.mapper";
    }
