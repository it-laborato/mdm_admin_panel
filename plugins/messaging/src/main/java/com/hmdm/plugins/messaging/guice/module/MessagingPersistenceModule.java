 ...
 * @author isv
 */
public class MessagingPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>MessagingPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public MessagingPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.messaging.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.messaging.persistence.domain";
    }
