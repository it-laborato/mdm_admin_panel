...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Xtra</code>
 * plugin.</p>
 *
 * @author isv
 */
public class XtraLiquibaseModule extends AbstractLiquibaseModule {
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/xtra.changelog.xml").getPath();
