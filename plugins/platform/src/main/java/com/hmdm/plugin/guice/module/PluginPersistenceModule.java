 ...
 * persistence layer of the <code>Plugin Platform</code>.</p>
 *
 * @author isv
 */
public class PluginPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>PluginPersistenceModule</code> instance. This implementation does nothing.</p>
     */
    public PluginPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugin.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugin.persistence.domain";
    }
}
