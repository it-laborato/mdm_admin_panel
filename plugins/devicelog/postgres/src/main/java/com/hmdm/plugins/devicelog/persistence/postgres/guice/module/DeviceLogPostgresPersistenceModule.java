 ...
 * @author isv
 */
public class DeviceLogPostgresPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>DeviceLogPostgresPersistenceModule</code> instance. This implementation does nothing.</p>
     */
    public DeviceLogPostgresPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.devicelog.persistence.postgres.dao.mapper";
    }
