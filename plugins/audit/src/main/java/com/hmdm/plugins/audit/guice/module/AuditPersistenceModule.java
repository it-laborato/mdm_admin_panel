 ...
 * @author isv
 */
public class AuditPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>AuditPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public AuditPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.audit.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.audit.persistence.domain";
    }
