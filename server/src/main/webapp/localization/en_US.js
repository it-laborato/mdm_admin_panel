...
document.localization ['en_US'] = {
    ...
    'signup.complete.title': 'Your account at MDM-lab is almost ready!',
    'signup.ready.title': 'Your account at MDM-lab is ready!',
    ...
    'about.line.1': 'MDM-lab control panel',
    ...
    'qrcode.help.line5': 'The QR code may contain the device ID for MDM-lab (so you don\'t need to enter it on a mobile device). To embed the device ID into the QR code, enter the device ID on this screen and click "Renew".',
    ...
    'ie.browser.notice.2': 'Recommended browser for using MDM-lab - <a href="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop">Chrome</a>.',
