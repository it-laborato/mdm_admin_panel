...
INSERT INTO applications (id, pkg, name, showicon, customerid, system, latestversion, runafterinstall) VALUES 
    ...
    (46, 'com.hmdm.launcher', 'MDM-Lab', false, 1, false, 10045, false),
    (47, 'com.huawei.android.internal.app', 'Huawei - выбор лаунчера', false, 1, true, 10046, false),
    (48, 'com.hmdm.pager', 'MDM-Lab Пейджер', true, 1, false, 10047, false),
    (49, 'com.hmdm.phoneproxy', 'Прокси для телефона', true, 1, false, 10048, false),
    (50, 'com.hmdm.emuilauncherrestarter', 'Помощник обновления MDM-Lab', false, 1, false, 10049, false),
...
INSERT INTO applicationversions (id, applicationid, version, url) VALUES 
    ...
    (10041, 42, '0', NULL),
    (10042, 43, '0', NULL),
    (10045, 46, '_HMDM_VERSION_', 'https://laborato.org/files/_HMDM_APK_'),
    (10046, 47, '0', NULL),
    (10047, 48, '1.02', 'https://laborato.org/files/pager-1.02.apk'),
    (10048, 49, '1.02', 'https://laborato.org/files/phoneproxy-1.02.apk'),
    (10049, 50, '1.04', 'https://laborato.org/files/LauncherRestarter-1.04.apk'),
    (10050, 51, '0', NULL),
    (10051, 52, '0', NULL),
    (10052, 53, '0', NULL),
    (10053, 54, '0', NULL),
...
(3, 'Фоновый режим', 'MDM-Lab работает в фоне, не ограничивая возможности пользователя.', 0, '12345678', '', '', NULL, 'SMALL', 'NO_HEADER', true, 1, NULL, NULL, NULL, NULL, 10045, 'com.hmdm.launcher.AdminReceiver', false, '350e0fb7fc3f4b7fe61cac75fd43818f', NULL, false, false, 0, NULL, NULL, 'mqttAlarm', 300, true, true, true);
...
INSERT INTO plugin_devicelog_settings_rules (id, settingid, name, active, applicationid, severity) VALUES (1, 1, 'MDM-Lab', true, 46, 'VERBOSE');
