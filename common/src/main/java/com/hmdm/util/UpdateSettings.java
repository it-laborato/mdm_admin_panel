...
public class UpdateSettings {
    ...
    public static String MANIFEST_URL = "https://laborato.org/hmdm-update-os.manifest.json";

    public static String STAT_URL = "https://app.laborato.org/rest/public/stats";
